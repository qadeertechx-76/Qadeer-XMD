...
REPO_NAME: process.env.REPO_NAME || "QADEER-KING",
BOT_NAME: process.env.BOT_NAME || "KIRA-MD",
DESCRIPTION: process.env.DESCRIPTION || "QADEER-KING PAKISTANI POWERFULL WHATSAPP BOT",
OWNER_NUMBER: process.env.OWNER_NUMBER || "923369423531",
OWNER_NAME: process.env.OWNER_NAME || "QADEER-KING Official",
ST_SAVE: process.env.ST_SAVE || "QADEER-KING-STATUS-SERVER",
BIO_TEXT: process.env.BIO_TEXT || "KIRA-MD-BY-ARSLANMD-OFFICIAL",
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*`STATUS SEEN BY QADEER-KING`* _*POWERD BY*_ *QADEER-KING Official Whtsapp Bot*",
FOOTER: process.env.FOOTER || "QADEER-KING",
COPYRIGHT: process.env.COPYRIGHT || "*㋛ QADEER-KING BY ARSLAN-MD OFFICIAL*",
VERSION: process.env.VERSION || "9.0.0",
NEWSLETTER: process.env.NEWSLETTER || "120363424804601329@newsletter",
WA_CHANNEL: process.env.WA_CHANNEL || "https://whatsapp.com/channel/0029VbCT0WnFsn0cPZKRDu3V",
...
OWNER_IMG: process.env.OWNER_IMG || "https://files.catbox.moe/ib9h2g.jpg",
CONVERT_IMG: process.env.CONVERT_IMG || "https://files.catbox.moe/ib9h2g.jpg",
AI_IMG: process.env.AI_IMG || "https://n.uguu.se/BlGoHUJU.jpg",
SEARCH_IMG: process.env.SEARCH_IMG || "https://files.catbox.moe/ib9h2g.jpg",
DOWNLOAD_IMG: process.env.DOWNLOAD_IMG || "https://files.catbox.moe/ib9h2g.jpg",
