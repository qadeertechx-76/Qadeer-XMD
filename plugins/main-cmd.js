...
async (conn, mek, m, { from, contextInfo, reply }) => {
    try {
        ...
        let envSettings = `╭━━━〔 *QADEER-KING-ENV* 〕━━━┈⊷
┃▸╭───────────
┃▸┃๏ *𝔼ℕ𝕍 𝕊𝔼𝕋𝕋𝕀ℕ𝔾𝕊 📡*
┃▸└───────────···๏
╰────────────────┈⊷
...
try{
let dec = `> QADEER-KING REPO INFO 🪀

╭⦁⦂⦁*━┉━┉━┉━┉━┉━┉━⦁⦂⦁
┃ 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${bot.OWNER_NUMBER}
┃ 
┃ QADEER-KING REPO: ${bot.REPO_LINK} 
┃
